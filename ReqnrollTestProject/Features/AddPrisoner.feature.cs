...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/AddPrisoner.feature.ndjson", 4);
        }
...
#line 8
 await testRunner.GivenAsync("The prison capacity is 100", ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
#line hidden
#line 9
 await testRunner.WhenAsync("I add a prisoner with Name \"Test Prisoner\", Age 30, crime \"Test Crime\", Entry Dat" +
                        "e \"03/05/2026\", Sentence Lenght 1, Release Date \"03/05/2027\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 10
 await testRunner.ThenAsync("Prisoner will be added, an ID will be generated and the Current Prisoner Count wi" +
                        "ll increase", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
...
#line hidden
            ...
            else
            {
                await this.ScenarioStartAsync();
#line 13
 await testRunner.GivenAsync("The prison capacity is 50 and im not authorized to add prisoners", ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
#line hidden
#line 14
 await testRunner.WhenAsync("I try to add a prisoner with Name \"Test Prisoner\", Age 30, crime \"Test Crime\", En" +
                        "try Date \"03/05/2026\", Sentence Lenght 1, Release Date \"03/05/2027\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 15
 await testRunner.ThenAsync("I receive an exception message", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
